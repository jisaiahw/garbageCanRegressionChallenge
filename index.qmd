...
tidy(model3)
```
The estimated coefficients of StressSurvey and time are 1.43 and -2.78, respectively. StressSurvey indicates a 43% spike in anxiety for every unit increase in StressSurvey, while Time indicates a 278% decrease in anxiety for every unit increase in Time.
...
tidy(model4)
```
The estimated coefficients are about the same as the true coefficients.
